...
if __name__ == "__main__":
    ...
    if FLAGS.guided:
        fnames = [(fname, fname[:-4] + '_edge'+fname[-4:]) for fname in fnames]
    ...
    trainer.add_callbacks([
        ...
        ng.callbacks.ModelRestorer(trainer.context['saver'], dump_prefix='logs/'+FLAGS.model_restore+'/snap', optimistic=True),
